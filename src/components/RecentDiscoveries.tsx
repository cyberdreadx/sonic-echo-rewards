    ...
    <Card className="bg-white border border-gray-200 w-full">
      ...
      <CardContent className="space-y-3 max-h-96 md:max-h-none overflow-y-auto">
        {discoveries.map((discovery, index) => (
          <div key={index} className={`p-3 md:p-4 rounded-lg border transition-all hover:bg-gray-50 active:scale-[0.98] w-full min-w-0 ${
            discovery.isNew 
            ...
            <div className="flex items-start justify-between mb-2 md:mb-3 gap-2">
              <div className="flex-1 min-w-0">
                <h4 className="font-medium text-black flex items-center gap-2 text-sm md:text-base">
                  <span className="truncate min-w-0">{discovery.track}</span>
                  {discovery.isNew && (
              ...
              <div className="text-right flex-shrink-0">
                <div className="text-black font-medium flex items-center gap-1 text-sm md:text-base whitespace-nowrap">
            ...
            <div className="flex items-center justify-between text-xs md:text-sm text-gray-500 gap-2 min-w-0">
